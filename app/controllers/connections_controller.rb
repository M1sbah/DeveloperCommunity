class ConnectionsController < ApplicationController
    ...
    def create
        ...
        # respond_to do |format|
            if @connection.save
                render_turbo_stream('replace',"user-connection-status", "connections/create",{connector: @connector})
    ...
    def update
        ...
        # respond_to do |format|
            if @connection.update(connection_params)
                render_turbo_stream('replace',"connection-status-#{@connection.id}", "connections/update", {connection: @connection})
