...
ActiveRecord::Schema[7.0].define(version: 2023_10_04_065339) do
  ...
  create_table "managements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organization_id"], name: "index_managements_on_organization_id"
  end
  ...
  add_foreign_key "managements", "organizations"
